    ...
    <div id="tb" class="bd">
        <div class="m-xs">
            <div style="margin-bottom: 5px;padding:5px 0;">
                <button onclick="daily(),changeColor(this);" style="width:32%;height: 35px;" id="btn0">日报</button>
                <button onclick="sale(),changeColor(this);" style="width:32%;height: 35px;" id="btn1">销售记录</button>
                <button onclick="pay(),changeColor(this);" style="width:32%;height: 35px;" id="btn2">进货记录</button>
            </div>从
            <input class="input-sm col-xs-4 easyui-datebox" prompt="开始时间" value="${startDate}"
                   ...
                   style="width:114px;height: 30px;padding: 5px 10px;font-size: 12px;line-height: 1.5;border-radius: 3px;"
                   id="startDate">到
    ...
    function daily() {
        ...
        $('#content').datagrid({
                    ...
                    columns: [[
                        ...
                        {field: 'roomcreatenum', title: '开局总数', width: '25%', align: 'center'},
                        {field: 'gamecardconsume', title: '钻石消耗', width: '25%', align: 'center'},
    ...
    function pay() {
        var tt = $('#content').datagrid({
                    ...
                    columns: [[
                        ...
                        {field: 'paytype', title: '支付方式', width: '31%', align: 'center'},
                        {field: 'createtime', title: '操作时间', width: '41%', align: 'center'}
                    ]]
                }
        );
